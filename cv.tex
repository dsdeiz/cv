...
\par{\centering{\normalsize 108 B Paho Road Dulonan Arevalo,\\
Iloilo City, Iloilo, Philippines\\
+63 939 9124230\\
\href{mailto:arn.french@gmail.com}{arn.french@gmail.com}}\par}
...
\begin{tabular}{r|p{11cm}}
  ...
  \begin{blacklist}
    ...
    \item Involved in the configuration and theme customization of Drupal websites.
  \end{blacklist}\\
  \multicolumn{2}{c}{}\\
...
\begin{description}[before={\renewcommand\makelabel[1]{\bfseries ##1.}}]
  ...
  \item[Testing Tools] Behat, Simpletest, Protractor, Jasmine
